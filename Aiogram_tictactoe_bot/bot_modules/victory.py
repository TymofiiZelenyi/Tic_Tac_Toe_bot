...
async def victory_check(list_inline_buttons: list, victory: list, step: str, callback: CallbackQuery, inline_main_keyboard: InlineKeyboardMarkup, list_step: list): #умови виграшу
    #
